...
class CommandTelaUsuario(Command):
    def __init__(self):
    ...
    def execute(self):
        ...
        while True:
            ...
            if opcao == "1":
                ...
                from Commands.CommandTelaEditUsuario import CommandTelaEditUsuario
                current_command = CommandTelaEditUsuario()
                break
            elif opcao == "4":
                self.__facade.deletar_usuario()
                break
            elif opcao == "5":
